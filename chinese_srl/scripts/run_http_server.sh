...
TOKENIZER_MODEL=${MODELDIR}/data  #Use this for chinese.
#LEMMATIZER_MODEL=${MODELDIR}/CoNLL2009-ST-English-ALL.anna-3.3.lemmatizer.model
POS_MODEL=${MODELDIR}/CoNLL2009-ST-Chinese-ALL.anna-3.3.postagger.model
#MORPH_MODEL=${MODELDIR}/  #No morph model for English.
PARSER_MODEL=${MODELDIR}/CoNLL2009-ST-Chinese-ALL.anna-3.3.parser.model
SRL_MODEL=${MODELDIR}/CoNLL2009-ST-Chinese-ALL.anna-3.3.srl-4.1.srl.model
